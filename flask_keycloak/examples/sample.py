...
def get_token():
    ...
    data = {
        ...
        'client_secret': 'ql7YJaUkhrpB8hBSEgvpLv34Mjz6A11s',
        'username': body['username'],
        'password': body['password']
    }
    url = ''.join([
        "https://idp.sk-nemo.com/",
        'realms/',
        "K11-ESS",
...
def refresh_token():
    ...
    url = "https://idp.sk-nemo.com/" + 'realms/' + \
        "K11-ESS" + '/protocol/openid-connect/token'
    response = requests.post(url, data=data)
...
def keycloak_post(endpoint, data):
    ...
    """
    url = "https://idp.sk-nemo.com/" + 'admin/realms/' + \
        "K11-ESS" + endpoint
...
def get_keycloak_access_token():
    ...
    response = requests.post("https://idp.sk-nemo.com/" + 'realms/' +
                             "K11-ESS" + '/protocol/openid-connect/token', data=data)
    if response.status_code != requests.codes.ok:
